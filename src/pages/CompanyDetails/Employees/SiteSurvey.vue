    ...
    >
      ...
      <template #status="{ data }">
        <div
          ...
          class="p-2 font-semibold px-2 py-1 rounded-lg text-sm whitespace-nowrap inline-block"
        >
          {{ data.status }}
        </div>
      </template>
...
onMounted(() => {
  nextTick(() => {
    console.log("Hardcoded data loaded:", siteSurvey.value);
  });
});
